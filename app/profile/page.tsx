...
export default function ProfilePage({ onBack }) {
  const [selectedTab, setSelectedTab] = useState("property"); // Default to Property List
            ...
            <tbody>
              {[...Array(7)].map((item, index) => (
                ...
                >
                  ...
                  <td className="py-0 px-4 text-sm text-gray-900">
                    Type {index + 1}
                  </td>
  ...
  return (
    <div className="container relative mx-auto p-6 flex flex-col gap-6">
      {/* Profile Section */}
      <div>
        <button onClick={onBack} className="text-black flex gap-2">
          <ArrowLeft />
          <span>Back</span>
        </button>
      </div>
      ...
      <div className="flex flex-col bg-white p-6 rounded-lg gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className=" flex gap-2 items-center text-[#101113]">
            <Image src={mailbox} alt="mailbox" className="text-gray-600" />
